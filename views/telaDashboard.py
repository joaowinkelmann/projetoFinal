...
class Dashboard(tk.Tk):
    def __init__(self):
        ...
        # self.login_successful = True # definimos como true aqui pois se chegamos a essa tela, é porque estamos logados

        self.gerenciador = GerenciadorDeProdutos()

        # self.login_window = LoginWindow(self, sel, self.login_successful_callback)
